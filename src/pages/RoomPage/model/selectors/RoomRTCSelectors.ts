...
export const getUserStreamSettings = (state: RoomRTCSchema) =>
  state.userStreamSettings
export const getMicrophoneStream = (state: RoomRTCSchema) =>
...
export const getActionStartWebCamStream = (state: RoomRTCSchema) =>
  state.startWebCamStream
export const getActionStopWebCamStream = (state: RoomRTCSchema) =>
