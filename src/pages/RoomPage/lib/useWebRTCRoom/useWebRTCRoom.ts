...
import { useAudio } from 'src/entities/AudioEffect';
...
import {
  RTCClient,
} from 'src/entities/RTCClient/lib/RTCClient/RTCClient';
import { socketClient } from 'src/shared/api/socket/socket';
import { useChatStore } from 'src/widgets/Chat/model/store/ChatStore';

import type { RTCChatMessage,
  TransmissionMessage } from 'src/entities/RTCClient';
import type { Answer,
  ClientId,
  Ice,
  Offer } from 'src/entities/RTCClient/lib/RTCClient/RTCClient';
